...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS,
                 ...
                 KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, LCTL(KC_INS), LSFT(KC_INS), KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, OSL(4),
	...
	[1] = LAYOUT(KC_TRNS, KC_PERC, KC_NUBS, LSFT(KC_NUBS), KC_PLUS, KC_RBRC, KC_NUM, KC_P7, KC_P8, KC_P9, KC_PMNS, KC_NO,
                 KC_TRNS, KC_CIRC, RALT(KC_7), RALT(KC_0), LSFT(KC_0), KC_HASH, KC_NO, KC_P4, KC_P5, KC_P6, KC_PPLS, LSFT(KC_2),
                 KC_TRNS, KC_EXLM, KC_ASTR, KC_LPRN, KC_AMPR, RALT(KC_MINS), KC_PSLS, KC_P1, KC_P2, KC_P3, KC_PCMM, KC_BSLS,
	...
	[2] = LAYOUT(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                 ...
                 KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_RBRC, KC_BSLS, KC_UP, KC_NO,
                 KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_UNDS, KC_TRNS, KC_TRNS, KC_PLUS, KC_MINS, KC_EQL, KC_LEFT, KC_DOWN, KC_RGHT,
    ...
    [4] = LAYOUT(KC_NO, LALT(KC_1), LALT(KC_2), LALT(KC_3), LALT(KC_4), LALT(KC_5), LALT(KC_6), LALT(KC_7), LALT(KC_8), LALT(KC_9), LALT(KC_0), KC_NO,
                 KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
                 KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
                 CW_TOGG, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS,
                 KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
                )
};
